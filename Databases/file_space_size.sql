...
SELECT   C.DRIVE, 
         ...
         CASE  
           ...
           END AS FILESIZE, 
         --CAST((B.SIZE * 8 / 1024.0) - (D.SPACEUSED / 128.0) AS DECIMAL(15,2)) SPACEFREE, -- valor em MB/GB
         CAST((((B.SIZE * 8 / 1024.0) - (D.SPACEUSED / 128.0)) * 100  ) / (B.SIZE * 8 / 1024.0) AS DECIMAL(15,2)) SPACEFREE, -- valor em % 
         B.PHYSICAL_NAME 
